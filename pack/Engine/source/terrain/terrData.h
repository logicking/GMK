...
public:
   void matchEdge(TerrainBlock* tb, U32 edge1,bool slope, U32 smoothBorder,F32 weight); // tb = the terrain block to match to, edge is the edge number, 0 being north, 1 east, 2 south, 3 west
   //>> Jonajoint End
};

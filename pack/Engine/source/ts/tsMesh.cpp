      ...
      if ( ( draw.matIndex & TSDrawPrimitive::TypeMask ) == TSDrawPrimitive::Triangles )
      {
         for ( S32 j=0; j < draw.numElements; j+=3 )
         {
               ...
               verts[idx0], &h, &v, &u ) && h < hit ) 
            {
               ...
               //rayInfo->material = draw.matIndex & TSDrawPrimitive::MaterialMask;//DS FIXME
...
//-----------------------------------------------------------------------------
void TSMesh::createTextureSpaceMatrix( VertexType *v0, VertexType *v1, VertexType *v2 )
{
   Point3F edge1, edge2;
   Point3F cp;
...
//-----------------------------------------------------------------------------
void TSMesh::fillTextureSpaceInfo( VertexType *vertArray )
{
   for (S32 i=0; i<primitives.size(); i++)
   {
      TSDrawPrimitive & draw = primitives[i];
      ...
      switch( drawType )
      {
         case GFXTriangleList:
         {
            ...
            {
               //createTextureSpaceMatrix( &vertArray[baseIdx[j]], &vertArray[baseIdx[j+1]], &vertArray[baseIdx[j+2]] );//DS FIXME
            }
            break;
         }
         ...
         case GFXTriangleStrip:
         {
            ...
            {
               //createTextureSpaceMatrix( &vertArray[p1Index], &vertArray[p2Index], &vertArray[baseIdx[j]] );//DS FIXME
               p1Index = p2Index;
               p2Index = baseIdx[j];
            }
            break;

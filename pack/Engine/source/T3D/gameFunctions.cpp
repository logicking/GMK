...
namespace {
   ...
   //.logicking >>
   static F32 sAspectRatio				= 0.f;        ///< force width to height aspect or 0 if calc by screen size
   //.logicking <<
...
//.logicking >>
DefineEngineFunction( setAspectRatio, void, ( F32 aspect ),,
	"@brief Set the aspect ratio for the render.\n"
	)
{
	sAspectRatio = mClampF(aspect, 0.f, 1000.f);
}

F32 GameGetAspectRatio()
{
	return(sAspectRatio);
}

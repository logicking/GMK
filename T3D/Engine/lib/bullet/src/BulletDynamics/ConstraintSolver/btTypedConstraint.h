...
protected:
	...
	bool m_breakable;
	btScalar m_breakThreshold;
	btScalar m_lockThreshold;
	btVector3 m_lockLimits;
...
//		btAssert(m_needsFeedback);
	...
	void	setBreakable(bool breakable)
	{
		...
		m_useSolveConstraintObsolete = breakable;
	}
	...
	btScalar	getBreakThreshold() const
	{
		return m_breakThreshold;
	}

	void	setBreakThreshold(btScalar threshold)
	{
		m_breakThreshold = threshold;
	}
	
	btScalar	getLockThreshold() const
	{
		return m_lockThreshold;
	}

	void	setLockThreshold(btScalar threshold)
	{
		m_lockThreshold = threshold;
	}

	void setLockLimits(btVector3 & limits)
	{
		m_lockLimits = limits;
	}
